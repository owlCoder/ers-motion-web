...
export const exercise5 = (): DocumentPage[] => [
  page('Vežba 5 — Poslovna logika i use-case sloj', [
    ...
    callout('info', 'Studija slučaja: ECommerce', 'ECommerce primer razdvaja Domain, podatke i repozitorijume, Application i implementaciju poslovnih servisa. Upiti i komande pripadaju aplikacionom sloju, dok konkretna baza ili spoljni web servis ostaju infrastrukturni detalji.'),
  ]),
