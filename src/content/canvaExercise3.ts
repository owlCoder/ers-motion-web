...
export const exercise3 = (): DocumentPage[] => [
  ...
  page('3.3. Tapiz Boards: backlog i User Story', [
    ...
    image('/course-assets/tapiz/03-backlog-view.webp', 'Pregled Product Backlog-a u stvarnom Tapiz Boards okruženju. Backlog omogućava timu da na jednom mestu sagleda stavke koje čekaju doradu, procenu ili izbor za naredni sprint.', 'Tapiz Boards — Product Backlog'),
    ...
    image('/course-assets/tapiz/04-user-story-detail.webp', 'Detalj User Story-ja prikazuje stvarne podatke koje Tapiz Boards nudi za opis, planiranje i praćenje stavke.', 'Tapiz Boards — detalj User Story-ja'),
    ...
    image('/course-assets/tapiz/05-create-or-edit-story.webp', 'Forma za kreiranje ili izmenu stavke koristi se za dosledno evidentiranje zahteva i podataka potrebnih timu za planiranje.', 'Tapiz Boards — kreiranje i izmena User Story-ja'),
    text('h3', '3.3.2. Kriterijumi prihvatanja i kontrolna lista'),
    image('/course-assets/tapiz/06-acceptance-criteria-example.webp', 'Kontrolna lista može da posluži za jasno evidentiranje proverljivih uslova ili koraka kada interfejs nema posebno polje za kriterijume prihvatanja.', 'Tapiz Boards — proverljivi uslovi kroz kontrolnu listu'),
  ...
  page('3.4. Tapiz Boards: razlaganje rada i tok kroz sprint', [
    ...
    image('/course-assets/tapiz/07-task-breakdown.webp', 'Primer razlaganja rada na konkretnije zadatke koji se mogu dodeliti, pratiti i proveravati u okviru šireg zahteva.', 'Tapiz Boards — razlaganje rada na zadatke'),
    ...
    image('/course-assets/tapiz/02-board-overview.webp', 'Pregled radne table u Tapiz Boards-u omogućava timu da prati raspored stavki i trenutno stanje rada u okviru izabrane iteracije.', 'Tapiz Boards — pregled radne table'),
    image('/course-assets/tapiz/08-workflow-transition.webp', 'Promena statusa predstavlja prelazak stavke kroz dogovorene faze procesa, a ne samo promenu njenog vizuelnog položaja na tabli.', 'Tapiz Boards — promena statusa i tok rada'),
    ...
    image('/course-assets/tapiz/09-priority-labels-assignees.webp', 'Prioritet, zaduženje i drugi raspoloživi podaci o stavci pomažu timu da razlikuje važnost rada, odgovornost i očekivani vremenski okvir.', 'Tapiz Boards — prioritet i zaduženje'),
    ...
    image('/course-assets/tapiz/10-activity-comments.webp', 'Komentari i hronologija aktivnosti čuvaju kontekst saradnje i omogućavaju timu da naknadno rekonstruiše važne promene na stavci.', 'Tapiz Boards — komentari i istorija aktivnosti'),
