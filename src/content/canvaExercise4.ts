...
export const exercise4 = (): DocumentPage[] => [
  ...
  page('4.1. Single Responsibility Principle', [
    ...
    text('paragraph', 'Posmatrajmo servis koji istovremeno generiše sadržaj poruke, čita korisnike i šalje e-mail. Problem nije broj linija koda, već činjenica da se ista klasa menja iz više nepovezanih razloga. SRP usmerava dizajn ka koherentnim komponentama čiji se razlog za izmenu može jasno opisati.'),
    ...
    callout('task', 'Rad na vežbi', 'U nastavnom ili projektnom kodu pronaći klasu koja radi najmanje dve nepovezane stvari. Napisati jednu rečenicu koja opisuje njenu trenutnu odgovornost, zatim predložiti razdvajanje i obrazložiti koje promene će ubuduće biti lokalizovane.'),
  ]),
  page('4.2. Open/Closed Principle', [
    text('h2', '4.2. Open/Closed Principle'),
    text('paragraph', 'Primer sa slanjem obaveštenja pokazuje tipičan OCP problem: ako centralni servis proverava tip poruke i grananjem bira e-mail, SMS i svaku novu vrstu, svako proširenje zahteva izmenu stabilnog koda. Varijabilno ponašanje je bolje smestiti iza ugovora, tako da se nova implementacija dodaje bez promene postojećeg klijenta.'),
  ...
  page('4.3. Liskov, Interface Segregation i Dependency Inversion', [
    ...
    text('paragraph', 'Liskov Substitution Principle zahteva da implementacija poštuje očekivanja ugovora. Sintaksno validno nasleđivanje nije dovoljno ako podtip menja značenje operacije ili narušava postuslove. ISP zatim ograničava širinu ugovora, dok DIP određuje smer zavisnosti između politike višeg nivoa i promenljivog tehničkog detalja.'),
  ...
  page('4.5. Studija slučaja: Logger–Blogger', [
    ...
    callout('info', 'Ključna ideja', 'Način čuvanja podataka i način logovanja mogu da se promene bez prepisivanja centralnog poslovnog toka. Ista ideja se prenosi u studentski projekat, ali tim bira sopstvene granice i nazive u skladu sa domenom.'),
  ]),
  page('4.6. Composition root i projektni checkpoint P2', [
    ...
    list([
      'Kreirati solution i početne projekte ili slojeve bez starter template-a.',
