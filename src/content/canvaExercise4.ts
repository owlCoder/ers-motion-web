...
export const exercise4 = (): DocumentPage[] => [
  page('Vežba 4 — SOLID i Clean Architecture', [
    ...
    text('paragraph', 'SOLID principi nisu skup formalnih pravila koja se primenjuju radi bodovanja, već smernice za oblikovanje sistema u kome su promene lokalizovane, zavisnosti zamenjive, a ponašanje lakše proverljivo. Clean Architecture isti način razmišljanja primenjuje na granice podsistema: poslovno jezgro treba da ostane nezavisno od korisničkog interfejsa, skladišta podataka i drugih promenljivih tehničkih detalja.'),
  ...
  page('4.6. Composition root i projektna kontrolna tačka P2', [
    text('h2', '4.6. Composition root i projektna kontrolna tačka P2'),
